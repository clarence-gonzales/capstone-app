...
<body>
  ...
  <div class="toggle-wrapper">
    <div class="toggle-container">
      <div class="toggle-button followers"><a href="contact.php">0 Followers</a></div>
      <div class="toggle-button following">0 Following</div>
    </div>
  </div>
  ...
  <div class="parent-container">
    <div class="followers-container">
      <div class="followers-header">
        <i class="fa-solid fa-user-check"></i><h4>Following</h4>
      </div>
      ...
      <div class="no-followers">
        You currently not following anyone
      </div>
    </div>
  </div>
